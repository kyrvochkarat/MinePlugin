...
namespace LandminePlugin.Commands
{
    ...
    public class MineListCommand : ICommand
    {
        public string Command => "minelist";
        public string[] Aliases => new[] { "mlist", "mines" };
        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            sb.AppendLine("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
            sb.AppendLine("Используйте 'mineremove <ID>' для удаления мины");
